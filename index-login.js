...
window.snapKitInit = function () {
  ...
  snap.loginkit.mountButton(loginButtonIconId, {
    clientId: 'ab27d5f7-803f-4ee9-afc9-4b0395c5cf05', /*YOU CHANGE: Must be changed to the development client ID on snapckit*/
    redirectURI: 'https://typical-citrine-guavaberry.glitch.me/', /*YOU CHANGE: Must be changed to your glitch project's url AND added as the redirect URI on snapkit */
    scopeList: [
      'user.display_name',
      'user.bitmoji.avatar',
    ],
